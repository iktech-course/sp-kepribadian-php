    ...
    <div class="h-screen bg-cover bg-no-repeat" style="background-image: url('../assets/bghome.png')">
        ...
        <div id="content">
            <div class="z-0 text-[#EBE9E9]">
                <h1 class="mb-5 text-xl md:text-3xl font-bold text-center">Pilih Ciri-ciri yang sesuai dengan Anda!</h1>
                <div class="mx-auto">
                    <div class="card w-40 sm:w-96 bg-black shadow-xl mx-auto my-7">
                        <figure class="px-3 pt-3 sm:px-10 sm:pt-10">
                            <img src="../assets/mask.jpg" alt="Shoes" class="rounded-md sm:rounded-xl" />
                        </figure>
    ...
    <script>
        $.ajax({
            ...
            success: function(data) {
                ...
                let isi = `apakah anda orang yang ` + date.name + ` ?`;
        ...
        $('#yes').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    let date = JSON.parse(data);
                    // console.log(date);
                    let isi = `apakah anda orang yang ` + date.data.name + ` ?`;
